...
public class SeatAllotedDetails implements Serializable {
    ...
    public String toString() {
        return "SeatAllotedDetails{" + "appl_no=" + appl_no + ", appl_dt=" + appl_dt + ", seat_cd=" + seat_cd + ", seat_descr=" + seat_descr + ", regn_no=" + regn_no + ", available_regn_no=" + available_regn_no + ", next_prefix_series=" + next_prefix_series + ", smartCardStatus=" + smartCardStatus + ", hsrpStatus=" + hsrpStatus + ", descr=" + descr + ", office_remark=" + office_remark + ", remark_for_public=" + remark_for_public + ", off_name=" + off_name + ", pur_cd=" + pur_cd + ", file_movement_slno=" + file_movement_slno + ", srl_no=" + srl_no + ", off_cd=" + off_cd + ", status=" + status + ", remarks=" + remarks + ", role_desc=" + role_desc + ", cntr_id=" + cntr_id + ", seatrole=" + seatrole + ", action_cd=" + action_cd + ", action_descr=" + action_descr + ", purpose_descr=" + purpose_descr + ", redirect_url=" + redirect_url + ", isInsuranceCheck=" + isInsuranceCheck + ", puccCheck=" + puccCheck + ", colour=" + colour + ", applStatusDescr=" + applStatusDescr + '}';
    }
}
