...
public class RetroFittingDetailsBeanModel {
	 ...
	 * this.tf_kit_no = cngDetailsBean.getTf_kit_no(); this.tf_kit_type =
	 * cngDetailsBean.getTf_kit_type(); this.tf_manu_name =
	 * cngDetailsBean.getTf_manu_name(); this.tf_workshop =
	 * cngDetailsBean.getTf_workshop(); this.tf_license_no =
	 * cngDetailsBean.getTf_license_no(); this.tf_cyc_sr_no =
	 * cngDetailsBean.getTf_cyc_sr_no(); this.tf_poll_norms =
	 * cngDetailsBean.getTf_poll_norms(); this.tf_approv_lettr_no =
	 * cngDetailsBean.getTf_approv_lettr_no(); this.cal_install_dt =
	 * cngDetailsBean.getCal_install_dt(); this.cal_hydro_dt =
	 * cngDetailsBean.getCal_hydro_dt(); this.cal_approv_dt =
	 * cngDetailsBean.getCal_approv_dt(); this.cngDetails_Visibility_tab =
	 * cngDetailsBean.isCngDetails_Visibility_tab(); this.cng_dobj_prv =
	 * cngDetailsBean.getCng_dobj_prv(); this.minDate = cngDetailsBean.getMinDate();
	 * }
	 */
