...
public class AxleBeanModel {
	...
	/*
	 * public AxleBeanModel(AxleBean axleBean) { this.tf_Front1 =
	 * axleBean.getTf_Front1(); this.tf_Rear1 = axleBean.getTf_Rear1();
	 * this.tf_Other1 = axleBean.getTf_Other1(); this.tf_Tandem1 =
	 * axleBean.getTf_Tandem1(); this.tf_Front = axleBean.getTf_Front();
	 * this.tf_Rear = axleBean.getTf_Rear(); this.tf_Other = axleBean.getTf_Other();
	 * this.tf_Tandem = axleBean.getTf_Tandem(); this.noOfAxle =
	 * axleBean.getNoOfAxle(); this.axle_dobj_prv = axleBean.getAxle_dobj_prv();
	 * this.r_overhang = axleBean.getR_overhang(); this.tf_Front_tyre =
	 * axleBean.getTf_Front_tyre(); this.tf_Rear_tyre = axleBean.getTf_Rear_tyre();
	 * this.tf_Other_tyre = axleBean.getTf_Other_tyre(); this.tf_Tandem_tyre =
	 * axleBean.getTf_Tandem_tyre(); }
	 */
