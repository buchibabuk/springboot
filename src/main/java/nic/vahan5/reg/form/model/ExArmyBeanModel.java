...
public class ExArmyBeanModel {
	...
	/*
	 * public ExArmyBeanModel(ExArmyBean exArmyBean) { this.tf_Voucher_no =
	 * exArmyBean.getTf_Voucher_no(); this.tf_VoucherDate =
	 * exArmyBean.getTf_VoucherDate(); this.tf_POP = exArmyBean.getTf_POP();
