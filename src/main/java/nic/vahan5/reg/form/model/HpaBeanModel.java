...
public class HpaBeanModel {
	...
	/*
	 * public HpaBeanModel(HpaBean hpaBean) { this.list_state =
	 * hpaBean.getList_state(); this.list_district = hpaBean.getList_district();
	 * this.list_hp_type = hpaBean.getList_hp_type(); this.hpaDobj =
	 * hpaBean.getHpaDobj(); this.hpa_dobj_prv = hpaBean.getHpa_dobj_prv();
	 * this.disable = hpaBean.isDisable(); this.maxDate = hpaBean.getMaxDate();
