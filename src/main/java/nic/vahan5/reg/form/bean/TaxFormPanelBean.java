package nic.vahan5.reg.form.bean;
...
import nic.vahan5.reg.form.dobj.DOTaxDetail;
...
public class TaxFormPanelBean implements Serializable {
    ...
    private Date finalEditableTaxFrom = new Date();
    private Date finalEditableTaxUpto = new Date();
