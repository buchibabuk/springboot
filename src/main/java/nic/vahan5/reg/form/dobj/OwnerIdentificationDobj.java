...
public class OwnerIdentificationDobj implements Serializable, Cloneable {
    ...
    public String toString() {
        return "OwnerIdentificationDobj{" + "state_cd=" + state_cd + ", off_cd=" + off_cd + ", appl_no=" + appl_no + ", regn_no=" + regn_no + ", mobile_no=" + mobile_no + ", email_id=" + email_id + ", pan_no=" + pan_no + ", aadhar_no=" + aadhar_no + ", passport_no=" + passport_no + ", ration_card_no=" + ration_card_no + ", voter_id=" + voter_id + ", dl_no=" + dl_no + ", verified_on=" + verified_on + ", flag=" + flag + ", mobileNoEditable=" + mobileNoEditable + ", ownerCatgEditable=" + ownerCatgEditable + ", ownerCatg=" + ownerCatg + ", ownerCdDept=" + ownerCdDept + ", dlRequired=" + dlRequired + ", pan_card_mandatory=" + pan_card_mandatory + '}';
    }
