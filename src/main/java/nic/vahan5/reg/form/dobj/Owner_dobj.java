...
import nic.vahan5.reg.form.bean.TaxFormPanelBean;
import nic.vahan5.reg.form.bean.fancy.RetenRegnNo_dobj;
import nic.vahan5.reg.form.dobj.fancy.AdvanceRegnNo_dobj;
...
public class Owner_dobj implements Serializable, Cloneable {
	...
	public String toString() {
		return "Owner_dobj [state_cd=" + state_cd + ", auctionDobj=" + auctionDobj + ", off_cd=" + off_cd + ", appl_no="
				+ appl_no + ", regn_no=" + regn_no + ", regn_dt=" + regn_dt + ", purchase_dt=" + purchase_dt
				+ ", owner_sr=" + owner_sr + ", owner_name=" + owner_name + ", f_name=" + f_name + ", c_add1=" + c_add1
				+ ", c_add2=" + c_add2 + ", c_add3=" + c_add3 + ", c_district=" + c_district + ", c_pincode="
				+ c_pincode + ", c_state=" + c_state + ", p_add1=" + p_add1 + ", p_add2=" + p_add2 + ", p_add3="
				+ p_add3 + ", p_district=" + p_district + ", p_pincode=" + p_pincode + ", p_state=" + p_state
				+ ", owner_cd=" + owner_cd + ", regn_type=" + regn_type + ", vh_class=" + vh_class + ", chasi_no="
				+ chasi_no + ", eng_no=" + eng_no + ", maker=" + maker + ", maker_model=" + maker_model + ", body_type="
				+ body_type + ", no_cyl=" + no_cyl + ", hp=" + hp + ", seat_cap=" + seat_cap + ", stand_cap="
				+ stand_cap + ", sleeper_cap=" + sleeper_cap + ", unld_wt=" + unld_wt + ", ld_wt=" + ld_wt + ", gcw="
				+ gcw + ", fuel=" + fuel + ", color=" + color + ", manu_mon=" + manu_mon + ", manu_yr=" + manu_yr
				+ ", norms=" + norms + ", wheelbase=" + wheelbase + ", cubic_cap=" + cubic_cap + ", floor_area="
				+ floor_area + ", ac_fitted=" + ac_fitted + ", audio_fitted=" + audio_fitted + ", video_fitted="
				+ video_fitted + ", vch_purchase_as=" + vch_purchase_as + ", vch_catg=" + vch_catg + ", dealer_cd="
				+ dealer_cd + ", sale_amt=" + sale_amt + ", laser_code=" + laser_code + ", garage_add=" + garage_add
				+ ", length=" + length + ", width=" + width + ", height=" + height + ", regn_upto=" + regn_upto
				+ ", fit_upto=" + fit_upto + ", tax_mode=" + tax_mode + ", annual_income=" + annual_income
				+ ", imported_vch=" + imported_vch + ", other_criteria=" + other_criteria + ", status=" + status
				+ ", op_dt=" + op_dt + ", c_state_name=" + c_state_name + ", c_district_name=" + c_district_name
				+ ", p_district_name=" + p_district_name + ", p_state_name=" + p_state_name + ", fuel_descr="
				+ fuel_descr + ", fit_dt=" + fit_dt + ", hypothecatedFlag=" + hypothecatedFlag + ", owner_identity="
				+ owner_identity + ", dob_temp=" + dob_temp + ", axleDobj=" + axleDobj + ", tempReg=" + tempReg
				+ ", otherStateVehDobj=" + otherStateVehDobj + ", cdDobj=" + cdDobj + ", featureCode=" + featureCode
				+ ", colorCode=" + colorCode + ", listHpaDobj=" + listHpaDobj + ", insDobj=" + insDobj
				+ ", trailerDobj=" + trailerDobj + ", exArmy_dobj=" + exArmy_dobj + ", imp_Dobj=" + imp_Dobj
				+ ", cng_dobj=" + cng_dobj + ", advanceRegNoDobj=" + advanceRegNoDobj + ", retenRegNoDobj="
				+ retenRegNoDobj + ", scrappedVehicleDobj=" + scrappedVehicleDobj + ", blackListedVehicleDobj="
				+ blackListedVehicleDobj + ", pmt_type=" + pmt_type + ", pmt_catg=" + pmt_catg + ", rqrd_tax_modes="
				+ rqrd_tax_modes + ", permitTypeList=" + permitTypeList + ", PermitCategoryList=" + PermitCategoryList
				+ ", taxModList=" + taxModList + ", vehType=" + vehType + ", linkedRegnNo=" + linkedRegnNo
				+ ", speedGovernorDobj=" + speedGovernorDobj + ", vehAgeExpire=" + vehAgeExpire + ", currentDate="
				+ currentDate + ", fitnessDobj=" + fitnessDobj + ", inspectionDobj=" + inspectionDobj
				+ ", speedGovernerList=" + speedGovernerList + ", ownerDetailsDo=" + ownerDetailsDo + ", newLoiNo="
				+ newLoiNo + ", numberOfTyres=" + numberOfTyres + ", reflectiveTapeDobj=" + reflectiveTapeDobj
				+ ", push_bk_seat=" + push_bk_seat + ", ordinary_seat=" + ordinary_seat + ", listTrailerDobj="
				+ listTrailerDobj + ", homoVchClass=" + homoVchClass + ", insertUpdateFlag=" + insertUpdateFlag
				+ ", insertUpdateHpaFlag=" + insertUpdateHpaFlag + ", deleteUpdateHpaFlag=" + deleteUpdateHpaFlag
				+ ", deleteUpdaeOtherStateFlag=" + deleteUpdaeOtherStateFlag + ", tempRegndeleteFlag="
				+ tempRegndeleteFlag + ", axelDeleteFlag=" + axelDeleteFlag + ", exArmyDeleteFlag=" + exArmyDeleteFlag
				+ ", importedVehDeleteFlag=" + importedVehDeleteFlag + ", retrofitDeleteFlag=" + retrofitDeleteFlag
				+ ", speedGovDeleteFlag=" + speedGovDeleteFlag + ", reflectiveTapeDeleteFlag="
				+ reflectiveTapeDeleteFlag + ", checkVaownerTempFlag=" + checkVaownerTempFlag + ", trailerDeleteFlag="
				+ trailerDeleteFlag + ", modelManuLocCode=" + modelManuLocCode + ", modelManuLocCodeDescr="
				+ modelManuLocCodeDescr + ", insertDeletelinkVehicle=" + insertDeletelinkVehicle + ", modelNameOnTAC="
				+ modelNameOnTAC + ", vehicleTrackingDetailsDobj=" + vehicleTrackingDetailsDobj + ", servicesType="
				+ servicesType + ", pmtServiceTypeList=" + pmtServiceTypeList + ", tmConfSwappingDobj="
				+ tmConfSwappingDobj + ", advanceOrRetenNoSelected=" + advanceOrRetenNoSelected + ", feeAction="
				+ feeAction + ", UserOffCd=" + UserOffCd + ", purCD=" + purCD + ", hypo=" + hypo + ", actionCd="
				+ actionCd + ", empCode=" + empCode + ", userCatg=" + userCatg + ", region_covered="
				+ Arrays.toString(region_covered) + ", region_covered_str=" + region_covered_str + "]";
	}
