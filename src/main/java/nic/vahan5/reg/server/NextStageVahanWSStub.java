...
public class NextStageVahanWSStub extends org.apache.axis2.client.Stub {
   ...
   // Auto generated method signature
    ...
    public NextStgWSResponse nextStgWS(
            NextStageVahanWSStub.NextStgWS nextStgWS0)
        ...
        try {
            ...
            java.lang.Object object = fromOM(
                    ...
                    NextStgWSResponse.class,
                    getEnvelopeNamespaces(_returnEnv));


            return (NextStgWSResponse) object;
   ...
   //Auto generated method signature for Asynchronous Invocations
    ...
    public void startnextStgWS(
            nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWS nextStgWS0,
            final nic.vahan5.reg.server.NextStageVahanWSCallbackHandler callback)
            throws java.rmi.RemoteException {
            ...
            public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(),
                            nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse.class,
                            getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultnextStgWS(
                            (nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse) object);
    ...
    private org.apache.axiom.om.OMElement toOM(nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWS param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWS.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, NextStgWS param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
            throws org.apache.axis2.AxisFault {
        ...
        try {
            ...
            emptyEnvelope.getBody().addChild(param.getOMElement(NextStageVahanWSStub.NextStgWS.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(
        ...
        try {
            ...
            if (nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWS.class.equals(type)) {

                return nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWS.Factory.parse(param.getXMLStreamReaderWithoutCaching());


            }

            if (nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse.class.equals(type)) {

                return nic.vahan5.reg.server.NextStageVahanWSStub.NextStgWSResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
